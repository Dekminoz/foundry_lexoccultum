...
Hooks.once("init", async function() {
    console.log(`Initializing Simple lexoccultum System`);
    ...
    Actors.registerSheet("lexoccultum", SimpleActorSheet, { makeDefault: true });
    Items.unregisterSheet("core", ItemSheet);
    Items.registerSheet("lexoccultum", SimpleItemSheet, { makeDefault: true });
...
async function _simpleDirectoryTemplates(collection, event) {
    ...
    let templates = entityCollection.filter(a => a.getFlag("lexoccultum", "isTemplate"));
    ...
    const dlg = await renderTemplate(`systems/lexoccultum/templates/sidebar/entity-create.html`, templateData);
